...
if __name__ == '__main__':
    ...
    if sys.argv[1]=='folder':
        ...
        false_colour(ica[0], 9, 29, 28, name='ICA')
        false_colour(ica[0], 18, 28, 42, name='ICA')

    elif sys.argv[1]=='fluo':
        data = root_dir / 'data' / 'images' / 'full_images' / 'watts_no_filter_2'


        h = DngFLuo.FluoStack(data.parent,data.name)

        h_stack = h.gen_fluo_stack_np()

        multi_plot(h_stack[3],
                   names=["940nm",
                          "850nm",
                          "740nm",
                          "660nm",
