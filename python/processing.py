...
class HSVimage():
    ...
    def __init__(self,
                 rgb_array):
        """
        Class for Hue Saturation Value images

        Parameters
        ----------
        rgb_array : str or ndarray
            input image used for RGBImage. eithe rpath to file object OR ndarray
    ...
    def tohsv(self,
         ...
         """
         Method converts RGB image to Hue saturation Value
    ...
    def h_threshold(self,
        ...
        h : hue image array
            DESCRIPTION.
        method : str, optional
            skimage threshold methods. 'otsu', 'li' or 'mean'
            https://scikit-image.org/docs/0.25.x/auto_examples/applications/plot_thresholding_guide.html#sphx-glr-auto-examples-applications-plot-thresholding-guide-py
        threshold : int or float, optional
            Threshold value if not using auto methods
    ...
    def fluo_image(self):
        """
        Generate floresecnce image using the hue distance

        Returns
        -------
        fluo : ndarray
            fluorescence derived by hue difference.

        """

        # run fluoresecene image
        ...
        # use threshold to assign band values
        r = self.rgb[:,:,0]
...
class ArrayHandler(ImageDict):
    def __init__(self,
                 ...
                 fname):
        """
        Class to handle LEDMSI array data

        Inherits from DataHandler.ImageDict

        Parameters
        ----------
        odir : str
            path to directorty used to store .
        fname : TYPE
            DESCRIPTION.
    ...
    def gen_image_stack_np(self,
         ...
         rotate: int, optional
             number of 90 dergree rotations to perform
    ...
    def reshape_stack(self,
                      stack):
        """
        Recast 3 dimensional array (x,y,spectral) to 2 dimensional array
        (x,spectral) for PCA etc
    ...
    def reshaped_to_rast(self,
                         ...
                         reshaped):
        """
        Recasts 2d array back to 3d array

        Parameters
        ----------
        stack : ndarray
            original input 3d spectralimage
        dims : int
            number of bands .
        reshaped : ndarray
            2d image.
    ...
    def compositor(self,
                   ...
                   bands):
        """
        takes a sequence of bands and averages them into a monochrome image
    ...
    def fluo_comp(self,
                  ...
                  ir_all=[10,11,7]):
        '''
        composite emphasisng fluorescence contibutions- using bands outside
        those most sensitive to the emission wavelength
        ...
        stack : ndarray
            image stack.
        uv_r : list, optional
            list of UV band indexes.
        b_g : list, optional
            list of blue bands. The default is [37,34,31].
        g_rb : list, optional
            list of green bands. The default is [26,22].
        r_all : TYPE, optional
            DESCRIPTION. The default is [19,16,13].
        ir_all : TYPE, optional
            DESCRIPTION. The default is [10,11,7].

        Returns
        -------
        nir_comp : ndarray
            nir flourescence composite
        r_comp : ndarray
            Red flourescence composite
        g_comp : ndarray
            green flourescence composite
        b_comp : ndarray
            blue flourescence composite
        uv_comp : ndarray
            UV flourescence composite
    ...
    def bin_refl_composites(self,
                            ...
                            uv=[44,47]):
        """
        Binned reflectance composite made of averaged reflectance bands- ie the
        most sensitive band at each emmision wavelength.
        ...
        stack : ndarray
            Input image stack
        nir : list, optional
            Bands comprising NIR. The default is [3,5,6,8,9,].
        r : list, optional
            Bands comprisng Red. The default is [12,15,18,21].
        g : list, optional
            Bands comprising green bands. The default is [25,28,22].
        b : list, optional
            Bands comprising blue bands. The default is [32,35,38,41].
        uv : list, optional
            Bands comprising UV bands. The default is [44,47].
...
class SampleMasks():
    ...
    def load_masks_from_json(self,
        ...
        im_dir : TYPE
            DESCRIPTION.
        img_col_key : TYPE, optional
            DESCRIPTION. The default is '_via_img_metadata'.
    ...
    def sampler(self,
        ...
        Parameters
        ----------
        image_mask_names : TYPE
            DESCRIPTION.
        #list of tuples containg mask name : TYPE
            DESCRIPTION.
        path to image : TYPE
            DESCRIPTION.
